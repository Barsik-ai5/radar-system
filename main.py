...
2. ВАЖНО: Фразы "тревога", "опасность", "ФПВ", "FPV", "БПЛА", "ракетная", "атака", "ударные группы", "авиационная", "бомбовая", "фиксация", "ударный", "хорнет", "УАБ", "отбой", "запуски", "взлет" — это ВАЖНЫЕ СООБЩЕНИЯ. 
🚨 ИСКЛЮЧЕНИЕ-УГРОЗА: Если в тексте упоминаются массовые запуски со стороны УКРАИНЫ (Днепропетровск, Харьков, Сумы, Волчанск, Авиаторское и т.д.) — ЭТО ПРЯМАЯ УГРОЗА НАШИМ РЕГИОНАМ! Обязательно публикуй с эмодзи 🔴 и присваивай тег региона.
3. ОПРЕДЕЛИ РЕГИОН. Мы отслеживаем:
   - Питер/Ленобласть -> [SPB]
   - Москва/МО -> [MSK]
   - Белгородская обл -> [BELGOROD]
   - Курск/Курская обл -> [KURSK]
   🚨 ЕСЛИ РЕГИОН ДРУГОЙ В РОССИИ (Брянск, Воронеж, Ростов, Орел, Тула и т.д.) — строго верни ИГНОР. Но помни про правило запуска из Украины (их не игнорировать!).
